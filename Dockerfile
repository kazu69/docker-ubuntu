...
ADD ./php/default_configure_options ${PHPENV_ROOT}/plugins/php-build/share/php-build/
...
# install idnkit
ADD ./php/src/idnkit-1.0.tar.gz /tmp/idnkit-1.0
ADD ./php/src/php-idnkit-20031204.tar.gz /tmp/php-idnkit
ADD ./php/src/php-idnkit.patch /tmp/php-idnkit/idnkit/

RUN cd /tmp/idnkit-1.0/idnkit-1.0-src && \
        ./configure && \
        make && make install
...
ADD php/php-build.sh /root/php-build.sh
RUN /bin/sh /root/php-build.sh
